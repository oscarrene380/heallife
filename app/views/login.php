...
<head>
    ...
    <title>Fundeso | Inicio de sesion</title>
...
<body class="hold-transition login-page" style="background-color: #40bcc4">
    <div class="login-box">
      ...
      if (@$_GET['Sesion'] == true) {
      ?>
            <div class="alert alert-success text-center"><?php echo $_GET['Sesion'] ?></div>
            <?php
      }
      ?>
            ...
            <a href="aplication/vistas/pacientes/register.php" class="text-center">Registrate como nuevo mienbro</a>
