                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div id="addEmployeeModal" class="modal fade">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form id="user_form" action="../../controladores/admin/citasCrudAdd.php" method="POST">
                            ...
                            <div id="editEmployeeModal" class="modal fade">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form id="update_form" action="../../controladores/admin/citasCrudUpdate.php" method="POST">
                                            <div class="modal-header">
