...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li><a href="horasCrud.php"><i class="fa fa-clock-o"></i> <span>Horas Atencion</span></a></li>
      <li><a href="horariosCrud.php"><i class="fa fa-calendar-o"></i> <span>Horarios</span></a></li>
      <li class="treeview">
