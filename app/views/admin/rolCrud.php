          ...
          <div class="row">
            <div class="col-md-3">
              <div class="input-group">
                ...
                <input type="text" class="form-control" placeholder="Buscar por estado">
              </div>
            </div>
            ...
            <div class="col-md-2">
              <div class="btn-group pull-right">
                <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="fa fa-user"></i> <span>Nuevo Rol</span></a>
              </div>
            </div>
          </div>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Niveles De Usuarios</h3>
                </div>
                <!-- /.box-header -->
                ...
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <?php
                      include "../../modelos/conexion.php";
                      $result = mysqli_query($con, "SELECT r.id_rol, r.descripcion, r.id_estado, e.descripcion FROM roles as r INNER JOIN estado as e on r.id_estado = e.id_estado;");
                      $i = 1;
              ...
              <div id="addEmployeeModal" class="modal fade">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <form id="user_form" action="../../controladores/admin/rolCrudAdd.php" method="POST">
                      <div class="modal-header">
                        <h4 class="modal-title">Agregar Nivel De Usuarios</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                      </div>
                      <div class="modal-body">
                        <div class="form-group col-md-12">
                          <label>Nivel Usuarios</label>
                          <input type="text" id="roles" name="rol" class="form-control" required>
                        </div>
              ...
              <div id="editEmployeeModal" class="modal fade">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <form id="update_form" action="../../controladores/admin/rolCrudUpdate.php" method="POST">
                      <div class="modal-header">
                        <h4 class="modal-title">Editar Roles De Usuarios</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                      </div>
                      <div class="modal-body">
                        <input type="hidden" id="r_id" name="idE" class="form-control" required>
                        <div class="form-group col-md-12">
                          <label>Nivel De Ususario</label>
                          <input type="text" id="r_rol" name="rolE" class="form-control" required>
                        </div>
                        <div class="form-group col-md-12">
                          <label>Estado</label>
              ...
              <div id="deleteEmployeeModal" class="modal fade">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <form id="delete_form" action="../../controladores/admin/rolCrudDelete.php" method="POST">
                      ...
                      <div class="modal-body">
                        <input type="hidden" id="id_d" name="rol_d" class="form-control">
