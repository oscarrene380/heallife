        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="active"><a href="menuPaciente.php"><i class="fa fa-home"></i> <span>Inicio</span></a></li>
                    <li><a href="citasPaciente.php"><i class="fa fa-medkit"></i> <span>Citas</span></a></li>
                ...
                <div class="row">
                    <div class="col-xs-12">
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        $result = mysqli_query($con, "SELECT re.id_res, re.id_usu, us.nombre, us.apellidos, fecha, re.id_hora, ho.hora, re.id_espe, es.descripcion, re.id_med, us2.nombre, us2.apellidos, re.id_estado, est.descripcion FROM `reservaciones` AS re
                                            ...
                                            INNER JOIN estado AS est ON re.id_estado = est.id_estado WHERE re.id_estado = 1 AND re.id_usu = '$idUsu' ORDER BY id_res ASC;");
                                        $i = 1;
                                            ...
                                            <tr id="<?php echo $row[0]; ?>">
                                                ...
                                                <td>
                                                    <a href="#editEmployeeModal" class="btn btn-warning editbtn">
                                                        <i class="material-icons update fa fa-medkit"><span> Ver Detalle</span></i>
                                                    </a>
                        ...
                        <div id="addEmployeeModal" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form id="user_form" action="../../controladores/pacientes/citasPacienteAdd.php" method="POST">
                        ...
                        <div id="editEmployeeModal" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form id="update_form" action="../../controladores/pacientes/citasPacienteUpdate.php" method="POST">
                                        <div class="modal-header">
                        ...
                        <div id="deleteEmployeeModal" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form id="delete_form" action="../../controladores/admin/citasCrudDelete.php" method="POST">
