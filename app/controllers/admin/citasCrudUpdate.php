...
if (empty($_POST['fechaE'])) {
    header("location:../../vistas/admin/citasCrud.php?Vacio=No dejar campos vacios");
} else {
    ...
    header("location:../../vistas/admin/citasCrud.php?Exito=Registro actualizado correctamente!");
}
