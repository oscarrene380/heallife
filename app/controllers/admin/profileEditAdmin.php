<?php
    ...
    if(empty($_POST['dui']) || empty($_POST['clave'])){
        header("location:../../vistas/admin/profileAdmin.php?Vacio=Por favor no deje campos en blanco!");
    }else{
        ...
        header("location:../../vistas/admin/profileAdmin.php?Exito=Se modifico su perfil exitosamente!");
    }
