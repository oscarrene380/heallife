...
if (empty($_POST['fechaE'])) {
    header("location:../../vistas/pacientes/citasPaciente.php?Vacio=No dejar campos vacios");
} else {
    ...
    header("location:../../vistas/pacientes/citasPaciente.php?Exito=Registro actualizado correctamente!");
}
